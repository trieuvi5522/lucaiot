    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className={isIIoT ? "py-6 md:py-8" : "py-12 md:py-16"}>
            <div className="container mx-auto px-4">
              <blockquote className="border-l-4 border-accent pl-6 text-muted-foreground italic text-base leading-relaxed max-w-2xl py-0 mx-[300px] my-0 px-0" style={{ textWrap: 'balance' } as React.CSSProperties}>
